 ...
 */
const MEMBERS = [
  { name: 'Bhawani Singh Shekhawat', phone: '9829011001', joined: P(-7), through: P(0),  amount: 500, enabled: true },
  { name: 'Devendra Singh Rathore',  phone: '9829011002', joined: P(-7), through: P(0),  amount: 500, enabled: true },
  { name: 'Karni Singh',             phone: '9829011003', joined: P(-7), through: P(0),  amount: 300, enabled: true },
  { name: 'Mahendra Singh',          phone: '9829011004', joined: P(-7), through: P(2),  amount: 200, enabled: true },
  { name: 'Pratap Singh Rathore',    phone: '9829011005', joined: P(-7), through: P(-1), amount: 200, enabled: true },
  { name: 'Rajveer Singh',           phone: '9829011006', joined: P(-7), through: P(-3), amount: 200, enabled: true },
  { name: 'Shyam Singh Chundawat',   phone: '9829011007', joined: P(-7), through: P(0),  amount: 200, enabled: true },
  { name: 'Ummed Singh',             phone: '9829011008', joined: P(-6), through: P(-1), amount: 200, enabled: true },
  { name: 'Gajendra Singh',          phone: '9829011009', joined: P(-6), through: P(0),  amount: 200, enabled: true },
  { name: 'Hukam Singh Naruka',      phone: '9829011010', joined: P(-6), through: P(-4), amount: 200, enabled: true },
  { name: 'Jitendra Singh',          phone: '9829011011', joined: P(-6), through: P(0),  amount: 200, enabled: true },
  { name: 'Kishan Singh Tanwar',     phone: '9829011012', joined: P(-5), through: P(-1), amount: 200, enabled: true },
  { name: 'Laxman Singh',            phone: '9829011013', joined: P(-5), through: P(0),  amount: 300, enabled: true },
  { name: 'Narendra Singh Bhati',    phone: '9829011014', joined: P(-5), through: P(-2), amount: 200, enabled: true },
  { name: 'Ranveer Singh',           phone: '9829011015', joined: P(-4), through: P(0),  amount: 200, enabled: true },
  { name: 'Surendra Singh Kachhawa', phone: '9829011016', joined: P(-4), through: P(-1), amount: 200, enabled: true },
  { name: 'Vikram Singh',            phone: '9829011017', joined: P(-3), through: P(0),  amount: 200, enabled: true },
  { name: 'Yashpal Singh',           phone: '9829011018', joined: P(-3), through: P(-2), amount: 200, enabled: true },
  { name: 'Bhanwar Lal Jat',         phone: '9829011019', joined: P(-7), through: null,  amount: 0,   enabled: false },
  { name: 'Om Prakash Sharma',       phone: '9829011020', joined: P(-5), through: null,  amount: 0,   enabled: false },
];
